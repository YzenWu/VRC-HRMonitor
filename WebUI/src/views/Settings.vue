    ...
    <div class="page-body">
      <CardGrid view="settings" :cards="CARDS">
        ...
        <template #appearance>
          ...
          <div class="x-gap" style="flex-wrap: wrap">
            <XSwitch v-bubble="t('settings.customhint')" :model-value="isCustom" :label="t('settings.custom')" style="min-width: 150px" @update:model-value="(v) => setCustom(Boolean(v))" />
          </div>

          <!-- Darkness and coloring are two separate dimensions, each of which starts with "System-compliant"; hides this line when customizing open -->
          ...
          <div class="x-gap" style="flex-wrap: wrap">
            ...
            <XRange
              v-bubble="t('settings.densityhint')"
        ...
        <template #head-advtheme>
          ...
          <ChevronDown class="x-btn-ico x-muted adv-chev" :class="{ open: advOpen }" @click="advOpen = !advOpen" />
        </template>
        <template #advtheme>
        ...
        <template #behavior>
          ...
          <div class="x-gap" style="flex-wrap: wrap">
            <XSwitch v-bubble="t('settings.autorestarthint')" v-model="autoRestart" :label="t('settings.autorestart')" style="min-width: 150px" />
          </div>

          <div class="x-gap" style="flex-wrap: wrap">
            <XSwitch
              v-bubble="t('settings.debughint')"
              :model-value="debug"
      ...
      <!-- About -->
      <CardGrid view="settings" :cards="ABOUT_CARDS">
        <template #head-about>
          {{ t('settings.about') }}
        </template>
        <template #about>
